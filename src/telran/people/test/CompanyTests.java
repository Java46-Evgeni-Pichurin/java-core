...
import telran.people.predicates.SalaryRangePredicate;
import telran.people.predicates.SalesPersonPredicate;
...
class CompanyTests {
    ...
    void companyIterableTest() {
        Employee[] expected = company.getAllEmployees();
        Employee[] actual = new Employee[employees.length];
