...
public class LinkedList<T> implements List<T> {
	...
	public void reverse() {
		...
		getReverse(forwardCurrent, backwardCurrent, limit);
		}

	private void getReverse(Node<T> forwardCurrent, Node<T> backwardCurrent, int limit) {
		if (limit == 0) {
			return;
		}
		...
		getReverse(forwardCurrent, backwardCurrent, limit - 1);
	}
